...
## 2026
- :large_blue_diamond: **`arXiv 2026`** [**SDPG**] Efficient On-policy Visual-RL via Stochastic Decoupled Policy Gradient [[Paper](https://arxiv.org/pdf/2605.26478.pdf)] 
...
- :large_blue_diamond: **`ICCV 2025`** [**DisWM**] Disentangled World Models: Learning to Transfer Semantic Knowledge from Distracting Videos for Reinforcement Learning [[Paper](https://arxiv.org/pdf/2503.08751)] [[Code](https://github.com/qiwang067/DisWM)] 
...
- :large_orange_diamond: **`arXiv 2025.10`** [**SegDAC**] SegDAC: Improving Visual Reinforcement Learning by Extracting Dynamic Objectc-Centric Representations from Pretrained Vision Models [[Paper](https://arxiv.org/pdf/2508.09325)] 
